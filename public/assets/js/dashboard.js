...
class Dashboard {
    ...
    renderRecentTasks(tasks) {
        ...
        if (!tasks || tasks.length === 0) {
            container.innerHTML = '<p class="text-center text-secondary">No recent tasks found</p>';
            return;
        }
    ...
    renderRecentProjects(projects) {
        ...
        if (!projects || projects.length === 0) {
            container.innerHTML = '<p class="text-center text-secondary">No projects found</p>';
            return;
        }
