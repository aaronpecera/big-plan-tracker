...
function handleLogin($usersCollection, $activitiesCollection) {
    ...
    logActivity($activitiesCollection, $user['_id'], 'login_success', 'User logged in successfully', 'user', $user['_id'], [
...
function handleLogout($activitiesCollection) {
    ...
    if ($userId) {
        // Log logout
        logActivity($activitiesCollection, $userId, 'logout', 'User logged out', 'user', $userId, [
            'username' => $username
        ]);
    }
